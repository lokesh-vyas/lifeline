...
class MasterRequestVC: UIViewController {
    ...
    override func viewDidLoad()
    {
        ...
        segmentObj.setTitle(MultiLanguage.getLanguageUsingKey("MY_REQUEST"), forSegmentAt: 0)
        segmentObj.setTitle(MultiLanguage.getLanguageUsingKey("MY_DONATION"), forSegmentAt: 1)
