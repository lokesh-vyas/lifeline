...
class HudBar
{
    ...
    func showHudWithCustomImagesAndMessage(message:String,imageName:String,view:UIView)
    {
        ...
        APESuperHUD.showOrUpdateHUD(icon: UIImage(named: imageName)!, message: message, duration: 2.0, presentingView: view, completion:
        { _ in
    ...
    {
        APESuperHUD.showOrUpdateHUD(icon: UIImage(named: "LifeLine_icon.png")!, message: message, duration: 2.0, presentingView: view, completion:
            { _ in
