...
public enum URLList:String
{
    ...
    case LIFELINE_Get_VolunteerList       = "http://api.lifeline.services/services/GetVolunteerList"
    case LIFELINE_Get_Inventory           = "http://api.lifeline.services/services/GetInventory"
