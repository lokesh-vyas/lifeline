...
class RequestInterator
{
    ...
    let builder = APIBuilder.sharedInstance.buildBloodRequestApi(LoginID: LoginId, BloodGroup: bloodgroup, WhatYouNedd: whatyouneed, WhenYouNedd: whenyouneed, Units: Units, PatientName: patientname, ContactPerson: contactperson, ContactNumber: contactnumber, DoctorName: doctorname, DoctorContact: doctorcontactnumber, DoctorEmailID: doctoremailID,centerID:centerID , CenterName: centername, CenterContactNumber: centercontactnumber, CenterAddress: centeraddress, City: City, State: State, Landmark: Landmark, Latitude: Latitude, Longitude: Longitude, Pincode: Pincode, country: Country, PersonalAppeal: personalappeal, SharedInSocialMedia: Sharedinsocialmedia)
