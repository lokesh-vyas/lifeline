        ...
        if Password == true {
            if ConfPassword == true {
                ...
                if txtConfirmPassword.text == txtNewPassword.text {
                    ...
                    self.view.makeToast("ERROR_PASSWORD_NOT_MATCHED", duration: 2.0, position: .bottom)
                }
                
            } else {
                self.view.makeToast("ERROR_CONFIRM_PASSWORD_VALIDATION", duration: 2.0, position: .bottom)
            }
        }else {
            self.view.makeToast("ERROR_PASSWORD_VALIDATION", duration: 2.0, position: .bottom)
        }
    }
    ...
    func ChangePasswordForService(params:Dictionary<String,Any>)
    {
        ...
        NetworkManager.sharedInstance.serviceCallForPOST(url: urlString,
                                                         ...
                                                         sucess: {
                                                            ...
                                                            {
                                                                HudBar.sharedInstance.hideHudFormView(view: self.view)
                                                                HudBar.sharedInstance.showHudWithLifeLineIconAndMessage(message: "ERROR_ENTER_OLD_PASSWORD", view: self.view)
                                                            }
        },
