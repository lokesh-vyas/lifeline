...
//
//
//  Created by Kishor on 17/02/16.
//  Copyright © 2016 Rehash. All rights reserved.
//
...
@IBDesignable class FloatLabelTextField: UITextField {
    ...
    {
        let rect = CGRect(x: 0.0, y: self.frame.size.height - 5, width: self.frame.size.width + 10, height: 1.0)
